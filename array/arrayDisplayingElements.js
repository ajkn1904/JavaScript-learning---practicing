//Declare an array for all the topics (programming languages) you have learned. Display them by using for loop.
...
//Declare an array for all the mobile phone's model you have used. Display them by using while loop.
